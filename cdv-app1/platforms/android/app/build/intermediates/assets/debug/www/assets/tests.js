...
define("web-app/tests/lint/app.lint-test", [], function () {
  ...
  QUnit.test('components/connect-4.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/connect-4.js should pass ESLint\n\n140:21 - \'createjs\' is not defined. (no-undef)\n143:21 - \'createjs\' is not defined. (no-undef)\n168:27 - \'createjs\' is not defined. (no-undef)\n177:30 - \'createjs\' is not defined. (no-undef)\n190:5 - \'createjs\' is not defined. (no-undef)\n354:7 - \'createjs\' is not defined. (no-undef)');
  });
